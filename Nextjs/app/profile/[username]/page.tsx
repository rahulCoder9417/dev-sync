...
import ProjectSectionProfile from '@/components/settings/ProjectSectionProfile';
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-primary w-full overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <section>
            ...
            {user.projects.length === 0 ? (
             ...
             <ProjectSectionProfile user={user}/>
            )}
          </section>
        </div>
      </div>
